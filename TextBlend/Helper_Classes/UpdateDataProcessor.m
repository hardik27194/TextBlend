...
/*
 ...
 userInfo.user_id=[NSNumber numberWithLong:[[userDict valueForKey:@"id"]intValue]];
 ...
 if([userDict valueForKey:@"discoverable"] && ![[userDict valueForKey:@"discoverable"] isEqual:[NSNull null]]){
 BOOL isDiscoverable=[[userDict valueForKey:@"discoverable"]boolValue];
 userInfo.is_user_discoverable= [NSNumber numberWithBool:isDiscoverable];
 
 }
 
 if([userDict valueForKey:@"suspended"] && ![[userDict valueForKey:@"suspended"] isEqual:[NSNull null]]){
 BOOL isSuspended=[[userDict valueForKey:@"suspended"]boolValue];
 
 userInfo.is_user_suspended=[NSNumber numberWithBool:isSuspended];
 
 }
 
 
 if([userDict valueForKey:@"radius"] && ![[userDict valueForKey:@"radius"] isEqual:[NSNull null]])
 self.currentUserInfo.user_search_radius=[userDict valueForKey:@"radius"];
 
 if([userDict valueForKey:@"status"] && ![[userDict valueForKey:@"status"] isEqual:[NSNull null]])
 userInfo.user_status=[userDict valueForKey:@"status"];
 ...
 if (error) {
 NSLog(@"Error while saving details %@",error);
 }
 NSLog(@"%@",userInfo);
 ;
 }
...
//
//    if([userDict valueForKey:@"id"] && ![[userDict valueForKey:@"id"] isEqual:[NSNull null]])
//        self.currentUserInfo.user_id=[NSNumber numberWithInt:[[userDict valueForKey:@"id"]intValue]];
//
//
//    if([userDict valueForKey:@"user_name"] && ![[userDict valueForKey:@"user_name"] isEqual:[NSNull null]])
//        self.currentUserInfo.userName=[userDict valueForKey:@"user_name"];
//
//    if([userDict valueForKey:@"email"] && ![[userDict valueForKey:@"email"] isEqual:[NSNull null]])
//        self.currentUserInfo.user_email=[userDict valueForKey:@"email"];
//
//
//    if([userDict valueForKey:@"authentication_token"] && ![[userDict valueForKey:@"authentication_token"] isEqual:[NSNull null]])
//        self.currentUserInfo.user_authentication_token=[userDict valueForKey:@"authentication_token"];
//
//    if([userDict valueForKey:@"avatar_url"] && ![[userDict valueForKey:@"avatar_url"] isEqual:[NSNull null]])
//        self.currentUserInfo.user_profile_image_url=[userDict valueForKey:@"avatar_url"];
//
//
//    if([userDict valueForKey:@"discoverable"] && ![[userDict valueForKey:@"discoverable"] isEqual:[NSNull null]])
//        self.currentUserInfo.is_user_discoverable=[userDict valueForKey:@"discoverable"];
//
//    if([userDict valueForKey:@"suspended"] && ![[userDict valueForKey:@"suspended"] isEqual:[NSNull null]])
//        self.currentUserInfo.is_user_suspended=[userDict valueForKey:@"suspended"];
//
//
//    if([userDict valueForKey:@"radius"] && ![[userDict valueForKey:@"radius"] isEqual:[NSNull null]])
//        self.currentUserInfo.user_search_radius=[userDict valueForKey:@"radius"];
//
//    if([userDict valueForKey:@"status"] && ![[userDict valueForKey:@"status"] isEqual:[NSNull null]])
//        self.currentUserInfo.user_status=[userDict valueForKey:@"status"];
//
//    [self.currentUserInfo.managedObjectContext save:nil];
...
/*
 ...
 NSPredicate *predicate=[NSPredicate predicateWithFormat:@"user_id == %@",[userDict valueForKey:@"id"]];
 UserInfo *userInfo;
 ...
 userInfo.user_status=current_status;
 NSError *error;
 [[kAppDelegate managedObjectContext]save:nil];
 if (error) {
 NSLog(@"Error while saving details %@",error);
 ...
 userInfo.user_profile_image_url=updated_url;
 NSError *error;
 [[kAppDelegate managedObjectContext]save:nil];
 if (error) {
 NSLog(@"Error while saving details %@",error);
 ...
 -(void)updateUserDetails:(NSDictionary *)userDict{
 //NSDictionary *dict=[userDict valueForKey:@"user"];
