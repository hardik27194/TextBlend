...
#define UPDATE_IN_APP_PURCHASE_NOTIFICATION @"UPDATE_IN_APP_PURCHASE_NOTIFICATION"
#define SELECT_INITIAL_FONT_NOTIFICATION @"SELECT_INITIAL_FONT_NOTIFICATION"
